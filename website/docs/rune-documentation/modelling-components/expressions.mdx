...
[^4]
[^4]: Do we need an additional example with 'empty'?
...
[^5]
[^5]: Do we need an example of this red highlighting?
...
[^6]
[^6]: Here and elsewhere, should 'true' have a capital 'T', as per our keywords?
