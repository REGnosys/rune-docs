...
and 
> string 
types by adding constraints or specific formatting.
**Example: Parameterized number**
This defines a positive decimal number with a maximum value of 5000. Note that the simple 
> int 
type is just a shorthand for a number with no fractional digits, such as 
