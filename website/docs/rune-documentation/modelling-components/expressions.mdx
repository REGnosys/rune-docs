...
Rune provides a small, controlled set of features for expressing simple logic – basic operations, comparisons and combinations of these into larger expressions. It’s intentionally limited so domain experts who are not software engineers can read it easily and avoid unintended behaviour. Simple expressions can be built up using operators to form more complex expressions.
...
4. [List operatorss](#4-list-operators)
...
[^3]
[^3]: Fuller code example required?
...
[^4]
[^4]: Here and elsewhere, should 'true' have a capital 'T', as per our keywords?
...
` strings join ", "`
[^5]
[^5]: Do we need an example of code here?
