...
### Syntax
You define a data type with the keyword type. It can include:

 <div class="two-column">
    <div>
      <ul>
        <li><strong>Name (required):</strong> Written in PascalCase (e.g. VehicleOwnership). Must be unique in its namespace.</li>
        <li><strong>Description (optional, but recommended):</strong> A plain-text definition inside angle brackets <code><"…"></code>.</li>
        <li><strong>Annotations (optional):</strong> Metadata enclosed in square brackets <code>[ ... ]</code>.</li>
      </ul>
    </div>
    <div>
      <p>
       <strong>Syntax:</strong><br>
<code>type <TypeName>: <"Description"></code>
 <code>[<annotation1>]</code>
  [<annotation2>]
  [...]
  <attribute1>
  <attribute2>
...
<code>type VehicleOwnership: <"Representative record of vehicle ownership">
  [metadata key]
  [rootType]</code>
      </p>
    </div>
