...
- Namespaces
[^1]
[^1]: Should we also include: Expressions; Synonyms (mapping)
...
- A deep path in a choice type e.g. `item ->> dayCountConvention`. See the [deep path operator.](/Rune%20DSL%20component%20-%20Expressions.mdx) 
[^2]
