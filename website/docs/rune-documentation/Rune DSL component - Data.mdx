...
**Example: Parameterized number**<br>
...
<p>
**Example: Parameterized string**<br>
...
So instead of typing the complex string definition, you can just use AlphaNumericText.
</p>
<p>
Type aliases PositiveInteger and AlphaNumericText are both used in this example.
    ...
    <div>
      <p>
       1 number(digits: 18, fractionalDigits: 17, min: 0, max: 5000)
      </p>
<p>
1 string(minLength: 3, maxLength: 5, pattern: "[a-zA-Z0-9]*")
</p>
<p>
...
Record types are straightforward; they’re pure data definitions and don't allow for custom validation logic.
    ...
    <div>
<li>**date:** Combines a day, month, and year.</li>
<li>**dateTime:** Combines a date and a simple time.</li>
<li>**zonedDateTime:** Combines date, time, and a time-zone specification for an unambiguous moment in time.</li>
    </div>
  </div>
